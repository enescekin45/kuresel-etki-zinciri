<?php
/**
 * Validator Approved Statistics API Endpoint
 */
...
try {
    ...
    // Get approved validations count
    $sql = "SELECT COUNT(*) as count FROM validation_records WHERE validator_id = ? AND validation_result = 'approved'";
