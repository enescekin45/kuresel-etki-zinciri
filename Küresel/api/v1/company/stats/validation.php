<?php
/**
 * Company Validation Statistics API Endpoint
 */
...
try {
    ...
    // Get validated supply chain steps count
    $db = Database::getInstance();
    $sql = "SELECT COUNT(*) as validated_count 
            FROM supply_chain_steps 
            WHERE company_id = ? AND validation_status = 'validated'";
