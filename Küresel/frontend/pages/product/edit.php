 ...
 * Edit Product Page
 * 
 * Allows company users to edit existing products
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !$error) {
    try {
        ...
        $productImages = []; // Initialize the array
        ...
        $updateData = [
            ...
            'product_images' => $productImages, // This will be JSON encoded by the Product class
...
<head>
    ...
    <title>Ürün Düzenle - Küresel Etki Zinciri</title>
